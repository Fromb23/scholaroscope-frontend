...
export function CBCSessionOutcomesPage() {
  ...
  const assistantContext = useMemo(
    () => ({
      ...
      emptyStateReason:
        !page.sessionLoading && !page.linksLoading && page.links.length === 0
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <CBCTeachingSessionNav sessionId={sessionId} active="outcomes" lessonHref={lessonHref} />
      ...
      <Card>
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link href={lessonHref} className="w-full sm:w-auto">

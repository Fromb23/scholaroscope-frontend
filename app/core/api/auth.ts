...
export const DEFAULT_WORKSPACE_CAPABILITIES: WorkspaceCapabilities = {
  ...
  can_approve_references: false,
  can_view_revenue_program: false,
  can_manage_revenue_policy: false,
  can_manage_revenue_cycles: false,
  can_run_revenue_calculations: false,
  can_review_revenue_statements: false,
  can_approve_revenue_cycles: false,
  is_workspace_owner: false,
  workspace_mode: null,
  workspace_behavior: null,
  revenue: {
    can_view_program: false,
    can_manage_policy: false,
    can_manage_cycles: false,
    can_run_calculations: false,
    can_review_statements: false,
    can_approve_cycles: false,
  },
...
function normalizeCapabilities(capabilities?: Partial<WorkspaceCapabilities>): WorkspaceCapabilities {
  ...
  return {
    ...
    ...(capabilities ?? {}),
    revenue: {
      ...DEFAULT_WORKSPACE_CAPABILITIES.revenue,

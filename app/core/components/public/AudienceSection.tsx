  ...
  return (
    <section className="theme-surface py-16 sm:py-20">
      <div className="mx-auto grid max-w-[1100px] gap-6 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        <article id="for-teachers" className="scroll-mt-24 rounded-2xl border p-6 theme-border theme-card">
        ...
        <article id="for-schools" className="scroll-mt-24 rounded-2xl border p-6 theme-border theme-card">

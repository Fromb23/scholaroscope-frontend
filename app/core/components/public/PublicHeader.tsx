...
export function PublicHeader({ variant = 'landing' }: PublicHeaderProps) {
  ...
  const landingVariant = variant === 'landing';
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 max-w-[1220px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <ScholaroscopeHomeLogo variant="header" />
        ...
        <div className="flex items-center gap-2 md:hidden">
          {!landingVariant ? <PublicThemeToggle /> : null}
          {landingVariant ? (
            <button
              type="button"
              className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg theme-button-secondary"

const FIELD_LABELS: Record<string, string> = {
  ...
  objective_provider: 'Learning objective source',
  objective_reference_id: 'Learning objective',
  teacher_defined_objective: 'Learning objective',
  total_marks: 'Total marks',
  rubric_scale: 'Rubric scale',
  report_component_key: 'Assessment component',

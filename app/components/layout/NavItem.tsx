    ...
    return (
      <li className="mb-1">
        <button
          ...
          className={`flex w-full items-center justify-between gap-3 rounded-lg px-4 py-3 text-sm font-medium transition-all duration-200 ${
            parentActive ? colors.active : `theme-muted ${colors.hover}`
          }`}
        >
  ...
  return (
    <li className="mb-1">
      <Link
        href={item.href}
        onClick={onNavigate}
        className={`flex items-center justify-between gap-3 rounded-lg px-4 py-3 text-sm font-medium transition-all duration-200 ${
          parentActive ? colors.active : `theme-muted ${colors.hover}`
        }`}
      >
        <div className="flex items-center gap-3">
